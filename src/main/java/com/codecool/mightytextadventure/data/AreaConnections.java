...
public class AreaConnections {
  ...
  public static void setupForrestDirections(Map<AreaName, Area> areas){
    // ========== F_NORTH ==========
    areas.get(AreaName.F_NORTH).addConnection("[Go North]", areas.get(AreaName.F_NORTH));
    ...
    areas.get(AreaName.F_EAST).addConnection("[Go East]", areas.get(AreaName.F_EAST));
    ...
    areas.get(AreaName.F_SOUTH).addConnection("[Go South]", areas.get(AreaName.F_SOUTH));
    ...
    areas.get(AreaName.F_WEST).addConnection("[Go West]", areas.get(AreaName.F_WEST));
  }
}
